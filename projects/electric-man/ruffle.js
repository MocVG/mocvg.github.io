(() => {
  ...
  var e,
    ...
    t = {
      791: (e, n, t) => {
        e.exports = t.p + "6a469b48ff44213ff708.wasm";
      },
      797: (e, n, t) => {
        e.exports = t.p + "e528aa66f1a99d4b8b48.wasm";
      },
    },
    a = {};
  function r(e) {
  ...
  (r.m = t),
    ...
    (r.u = (e) =>
      "core.ruffle." +
      { 69: "f1967db22c9824b9a3c8", 655: "f5287d2a7b59790e7a16" }[e] +
      ".js"),
    (r.g = (function () {
  ...
  function p() {
    ("function" == typeof Array.prototype.reduce &&
      ...
      ("function" == typeof Window && m(Window)) ||
  ...
  async function v(e) {
    null === h &&
      (h = (async function (e) {
        var n, t, a;
        p();
        const o = (await Promise.all([l(), f(), c(), d(), u()])).every(Boolean);
        o ||
          console.log(
            "Some WebAssembly extensions are NOT available, falling back to the vanilla WebAssembly module"
          ),
          null === (t = (n = Xt.options).onFirstLoad) ||
            void 0 === t ||
            t.call(n),
          (Xt.options.onFirstLoad = () => {});
        const {
          default: i,
          RuffleInstanceBuilder: s,
          ZipWriter: m,
        } = await (o
          ? r.e(69).then(r.bind(r, 69))
          : r.e(655).then(r.bind(r, 655)));
        let h;
        const v = o ? new URL(r(791), r.b) : new URL(r(797), r.b),
          b = await fetch(v),
          g = "function" == typeof ReadableStreamDefaultController;
        if (e && g) {
          const n =
            (null === (a = null == b ? void 0 : b.headers) || void 0 === a
              ? void 0
          ...
          h = new Response(
            new ReadableStream({
              async start(n) {
                var a;
                const o =
                  null === (a = b.body) || void 0 === a
                    ? void 0
                    : a.getReader();
                if (!o) throw "Response had no body";
                for (e(t, r); ; ) {
                  const { done: a, value: i } = await o.read();
                  if (a) break;
                  (null == i ? void 0 : i.byteLength) &&
                    (t += null == i ? void 0 : i.byteLength),
                    n.enqueue(i),
                    e(t, r);
                }
                n.close();
  ...
  function z(e, n, t) {
    if (t === n) return !0;
    if (t instanceof w && n instanceof w && t.value === n.value) return !0;
    if (n instanceof w && "string" == typeof t) {
  ...
  function S(e, n, t) {
    return n[t]
      ? q(e, n[t].value)
      : (e.reportError(new RangeError("No default")), new g());
  }
  function j(e, n) {
    const t = [],
      a = Object.create(null);
    for (const r of n)
      "narg" === r.type ? (a[r.name] = E(e, r.value)) : t.push(E(e, r));
  ...
  function E(e, n) {
    switch (n.type) {
      case "str":
        return n.value;
      case "num":
        return new w(n.value, { minimumFractionDigits: n.precision });
      case "var":
        return (function (e, { name: n }) {
          ...
          switch (typeof t) {
            ...
            case "number":
              return new w(t);
            case "object":
              if (t instanceof Date) return new k(t.getTime());
            default:
              return (
                e.reportError(
                  new TypeError(
      ...
      case "mesg":
        return (function (e, { name: n, attr: t }) {
          ...
          return e.reportError(new ReferenceError(`No value: ${n}`)), new g(n);
        })(e, n);
      case "term":
        return (function (e, { name: n, attr: t, args: a }) {
          ...
          if (!o)
            return (
              e.reportError(new ReferenceError(`Unknown term: ${r}`)), new g(r)
            );
          if (t) {
            const n = o.attributes[t];
            if (n) {
              e.params = j(e, a).named;
              const t = q(e, n);
      ...
      case "func":
        return (function (e, { name: n, args: t }) {
          ...
          try {
            ...
            return e.reportError(t), new g(`${n}()`);
          }
        })(e, n);
      case "select":
        return (function (e, { selector: n, variants: t, star: a }) {
          let r = E(e, n);
          if (r instanceof g) return S(e, t, a);
          for (const n of t) {
            if (z(e, r, E(e, n.key))) return q(e, n.value);
          }
          return S(e, t, a);
        })(e, n);
      default:
  ...
  function C(e, n) {
    if (e.dirty.has(n))
      return e.reportError(new RangeError("Cyclic reference")), new g();
    e.dirty.add(n);
    const t = [],
      a = e.bundle._useIsolating && n.length > 1;
    for (const r of n)
      if ("string" != typeof r) {
        if ((e.placeables++, e.placeables > y))
          throw (
            (e.dirty.delete(n),
            new RangeError(
              `Too many placeables expanded: ${e.placeables}, max allowed is ${y}`
            ))
          );
        a && t.push(R), t.push(E(e, r).toString(e)), a && t.push(x);
      } else t.push(e.bundle._transform(r));
    return e.dirty.delete(n), t.join("");
  }
  function q(e, n) {
    return "string" == typeof n ? e.bundle._transform(n) : C(e, n);
  }
  class A {
    constructor(e, n, t) {
  ...
  function I(e, n) {
    let t = e[0];
    if (t instanceof g) return new g(`NUMBER(${t.valueOf()})`);
    if (t instanceof w) return new w(t.valueOf(), { ...t.opts, ...F(n, D) });
    if (t instanceof k) return new w(t.valueOf(), { ...F(n, D) });
  ...
  function $(e, n) {
    let t = e[0];
    if (t instanceof g) return new g(`DATETIME(${t.valueOf()})`);
    if (t instanceof k) return new k(t.valueOf(), { ...t.opts, ...F(n, P) });
    if (t instanceof w) return new k(t.valueOf(), { ...F(n, P) });
  ...
  class M {
    ...
    formatPattern(e, n = null, t = null) {
      ...
      let a = new A(this, t, n);
      try {
        return C(a, e).toString(a);
      } catch (e) {
        if (a.errors && e instanceof Error)
          return a.errors.push(e), new g().toString(a);
        throw e;
      }
    }
  }
  const T = /^(-?[a-zA-Z][\w-]*) *= */gm,
    ...
    U = /(-?[0-9]+(?:\.([0-9]+))?)/y,
    N = /([a-zA-Z][\w-]*)/y,
    _ = /([$-])?([a-zA-Z][\w-]*)(?:\.([a-zA-Z][\w-]*))?/y,
    B = /^[A-Z][A-Z0-9_-]*$/,
    J = /([^{}\n\r]+)/y,
    H = /([^\\"\n\r]*)/y,
    V = /\\([\\"])/y,
    Z = /\\u([a-fA-F0-9]{4})|\\U([a-fA-F0-9]{6})/y,
    K = /^\n+/,
    G = / +$/,
    Q = / *\r?\n/g,
    Y = /( *)$/,
  ...
  class le {
    constructor(e) {
      ...
      function l() {
        let a;
        if ((t(J) && (a = i(J)), "{" === e[n] || "}" === e[n]))
          return u(a ? [a] : [], 1 / 0);
        let r = b();
        return r
          ? a
            ? u([a, r], r.length)
            : ((r.value = g(r.value, K)), u([r], r.length))
          : a
          ? g(a, G)
          : null;
      }
      function u(a = [], r) {
        ...
        let o = a.length - 1,
          s = a[o];
        "string" == typeof s && (a[o] = g(s, G));
        let l = [];
        for (let e of a)
          e instanceof ue && (e = e.value.slice(0, e.value.length - r)),
            e && l.push(e);
        return l;
      }
      function c() {
        ...
        if (r(re)) {
          ...
          return r(ee, SyntaxError), { type: "select", selector: e, ...n };
        }
      ...
      function d() {
        ...
        if (t(_)) {
          ...
          if (r(ae)) {
            ...
            if (B.test(a)) return { type: "func", name: a, args: o };
  ...
  class de {
    ...
    addLikelySubtags() {
      const e = (function (e) {
        if (Object.prototype.hasOwnProperty.call(fe, e)) return new de(fe[e]);
        const n = new de(e);
        if (n.language && me.includes(n.language))
  ...
  function pe(e, n, { strategy: t = "filtering", defaultLocale: a } = {}) {
    const r = (function (e, n, t) {
      const a = new Set(),
        r = new Map();
      for (let e of n) new de(e).isWellFormed && r.set(e, new de(e));
      e: for (const n of e) {
  ...
  for (const [e, n] of Object.entries(he)) {
    ...
    if (n)
      for (const [a, r] of Object.entries(n))
        if (r)
          for (const n of t.addResource(new le(r)))
  ...
  function ge(e, n) {
    const t = pe(navigator.languages, Object.keys(ve), {
      defaultLocale: "en-US",
    });
    for (const a in t) {
      const r = be(t[a], e, n);
  ...
  const ze = document.createElement("template"),
    ...
    je = ke("style", "static-styles"),
    Ee = ke("style", "dynamic-styles"),
    Ce = ke("div", "container"),
    qe = ke("div", "play-button"),
    Ae = ke("div", void 0, "icon"),
    Fe = ke(
      "svg",
      void 0,
      void 0,
    ...
    De = ke("defs", void 0, void 0, void 0, Se),
    Ie = ke(
      "linearGradient",
      "a",
      void 0,
    ...
    We = document.createElementNS(Se, "use");
  We.href.baseVal = "#b";
  const Le = ke("div", "unmute-overlay"),
    Ue = ke("div", void 0, "background"),
    Ne = ke("div", void 0, "icon"),
    _e = ke(
      "svg",
      "unmute-overlay-svg",
      void 0,
    ...
    Ze = ke("input", "virtual-keyboard", void 0, {
      type: "text",
      autocapitalize: "off",
      autocomplete: "off",
      autocorrect: "off",
    }),
    Ke = ke("div", "splash-screen", "hidden"),
    Ge = ke(
      "svg",
      void 0,
      "logo",
    ...
    Qe = ke("g", void 0, void 0, void 0, Se),
    Ye = ke(
      "path",
      void 0,
      void 0,
    ...
    tn = ke("div", void 0, "loadbar"),
    an = ke("div", void 0, "loadbar-inner"),
    rn = ke("div", "save-manager", "modal hidden"),
    on = ke("div", "modal-area", "modal-area"),
    sn = ke("span", void 0, "close-modal"),
    ln = ke("div", void 0, "general-save-options"),
    un = ke("span", void 0, "modal-button"),
    cn = ke("table", "local-saves"),
    dn = ke("div", "volume-controls-modal", "modal hidden"),
    fn = ke("div", void 0, "modal-area"),
    mn = ke("div", "volume-controls"),
    pn = ye("checkbox", "mute-checkbox"),
    hn = ye("range", "volume-slider", "0", "100", "1"),
    vn = Re("volume-mute", "mute-checkbox");
  vn.title = ge("volume-controls-unmute");
  const bn = Re("volume-min", "mute-checkbox"),
    gn = Re("volume-mid", "mute-checkbox"),
    wn = Re("volume-max", "mute-checkbox");
  [bn, gn, wn].forEach((e) => (e.title = ge("volume-controls-mute")));
  const kn = ke("span", "volume-slider-text"),
    yn = ke("span", void 0, "close-modal"),
    Rn = ke("div", "video-modal", "modal hidden"),
    xn = ke("div", void 0, "modal-area"),
    zn = ke("span", void 0, "close-modal"),
    Sn = ke("div", "video-holder"),
    jn = ke("div", "hardware-acceleration-modal", "modal hidden"),
    En = ke("div", void 0, "modal-area"),
    Cn = ke("span", void 0, "close-modal"),
    qn = ke("span", "acceleration-text");
  qn.textContent = ge("enable-hardware-acceleration");
  const An = document.createElement("a");
  (An.href =
    "https://github.com/ruffle-rs/ruffle/wiki/Frequently-Asked-Questions-For-Users#chrome-hardware-acceleration"),
    (An.target = "_blank"),
    (An.className = "modal-button"),
    (An.textContent = ge("enable-hardware-acceleration-link"));
  const Fn = ke("div", "clipboard-modal", "modal hidden"),
    Dn = ke("div", void 0, "modal-area"),
    In = ke("span", void 0, "close-modal"),
    Pn = ke("h2", void 0);
  Pn.textContent = ge("clipboard-message-title");
  const $n = ke("p", "clipboard-modal-description"),
    On = navigator.userAgent.includes("Mac OS X") ? "Command" : "Ctrl",
    Mn = ke("p", void 0),
    Tn = ke("b", void 0);
  Tn.textContent = `${On}+C`;
  const Wn = ke("span", void 0);
  Wn.textContent = ge("clipboard-message-copy");
  const Ln = ke("p", void 0),
    Un = ke("b", void 0);
  Un.textContent = `${On}+X`;
  const Nn = ke("span", void 0);
  Nn.textContent = ge("clipboard-message-cut");
  const _n = ke("p", void 0),
    Bn = ke("b", void 0);
  Bn.textContent = `${On}+V`;
  const Jn = ke("span", void 0);
  Jn.textContent = ge("clipboard-message-paste");
  const Hn = ke("div", "context-menu-overlay", "hidden"),
    Vn = ke("ul", "context-menu");
  xe(ze.content, je),
    xe(ze.content, Ee),
    xe(ze.content, Ce),
    xe(Ce, qe),
      ...
      for (; a < 999; ) {
        ...
        if (
          ...
          return (
            ...
            (Zn[e] = { class: n, name: t, internalName: e }),
            t
          );
        a += 1;
      }
  ...
  var Gn, Qn, Yn, Xn, et, nt, tt, at, rt, ot;
  !(function (e) {
  ...
  const it = {
      ...
      letterbox: Qn.Fullscreen,
      unmuteOverlay: Yn.Visible,
      upgradeToHttps: !0,
      ...
      openUrlMode: rt.Allow,
      allowNetworking: ot.All,
      openInNewTab: null,
      socketProxy: [],
      fontSources: [],
      defaultFonts: {},
      credentialAllowList: [],
      playerRuntime: at.FlashPlayer,
    },
    st = "application/x-shockwave-flash",
    lt = "application/futuresplash",
    ut = "application/x-shockwave-flash2-preview",
    ct = "application/vnd.adobe.flash.movie";
  function dt(e, n) {
    const t = (function (e) {
      let n = "";
      try {
  ...
  const ft = {
    versionNumber: "0.1.0",
    versionName: "nightly 2024-07-01",
    versionChannel: "nightly",
    buildDate: "2024-07-01T00:06:47.586Z",
    commitHash: "4b849cd52a8acf42a6d38d81902bacf9580f5f71",
  };
  let mt = null,
    pt = !1;
  try {
    if (
      ...
      e.endsWith(".js") || e.endsWith("/") || (e += "/"),
        (mt = new URL(".", e)),
        (pt = mt.protocol.includes("extension"));
    }
  } catch (e) {
  ...
  function vt(e, n) {
    if (
      (ht(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess),
      ht(n.backgroundColor) &&
      ...
      ht(n.upgradeToHttps) && e.setUpgradeToHttps(n.upgradeToHttps),
      ht(n.compatibilityRules) && e.setCompatibilityRules(n.compatibilityRules),
      ht(n.letterbox) && e.setLetterbox(n.letterbox.toLowerCase()),
      ht(n.base) && e.setBaseUrl(n.base),
      ht(n.menu) && e.setShowMenu(n.menu),
      ht(n.allowFullscreen) && e.setAllowFullscreen(n.allowFullscreen),
      ht(n.salign) && e.setStageAlign(n.salign.toLowerCase()),
      ht(n.forceAlign) && e.setForceAlign(n.forceAlign),
      ht(n.quality)
        ...
        : void 0 !== window.orientation &&
          ...
          e.setQuality("low")),
      ht(n.scale) && e.setScale(n.scale.toLowerCase()),
      ht(n.forceScale) && e.setForceScale(n.forceScale),
      ht(n.frameRate) && e.setFrameRate(n.frameRate),
      ht(n.wmode) && e.setWmode(n.wmode),
      ht(n.logLevel) && e.setLogLevel(n.logLevel),
      ht(n.maxExecutionDuration) &&
      ...
      ht(n.playerVersion) && e.setPlayerVersion(n.playerVersion),
      ht(n.preferredRenderer) && e.setPreferredRenderer(n.preferredRenderer),
      ht(n.openUrlMode) && e.setOpenUrlMode(n.openUrlMode.toLowerCase()),
      ht(n.allowNetworking) &&
        e.setAllowNetworking(n.allowNetworking.toLowerCase()),
      ht(n.credentialAllowList) &&
        e.setCredentialAllowList(n.credentialAllowList),
      ht(n.playerRuntime) && e.setPlayerRuntime(n.playerRuntime),
      ht(n.socketProxy))
    )
      for (const t of n.socketProxy)
        e.addSocketProxy(t.host, t.port, t.proxyUrl);
  }
  const bt = "https://ruffle.rs",
    gt = /^\s*(\d+(\.\d+)?(%)?)/;
  let wt = !1;
  var kt, yt;
  function Rt(e) {
  ...
  class zt {
    constructor(e = "#", n = ge("view-error-details")) {
  ...
  class St extends HTMLElement {
    ...
    constructor() {
      super(),
        ...
        this.shadow.appendChild(ze.content.cloneNode(!0)),
      ...
      e &&
        ...
        (e.innerText = ge("save-backup-all")));
      const n = this.unmuteOverlay.querySelector("#unmute-overlay-svg");
      if (n) {
        n.querySelector("#unmute-text").textContent = ge("click-to-unmute");
      }
      (this.contextMenuOverlay = this.shadow.getElementById(
        ...
        (this._readyState = yt.HaveNothing),
        (this._metadata = null),
    ...
    updateStyles() {
      if (this.dynamicStyles.sheet) {
        ...
        if (null != e) {
          const n = St.htmlDimensionToCssDimension(e.value);
          null !== n &&
            this.dynamicStyles.sheet.insertRule(`:host { width: ${n}; }`);
        }
        const n = this.attributes.getNamedItem("height");
        if (null != n) {
          const e = St.htmlDimensionToCssDimension(n.value);
          null !== e &&
    ...
    async ensureFreshInstance() {
      ...
      const [a, r] = await v(this.onRuffleDownloadProgress.bind(this)).catch(
        (e) => {
          if (
            (console.error(`Serious error loading Ruffle: ${e}`),
            "file:" === window.location.protocol)
          )
            e.ruffleIndexError = kt.FileProtocol;
          else {
            e.ruffleIndexError = kt.WasmNotFound;
            const n = String(e.message).toLowerCase();
            n.includes("mime")
              ? (e.ruffleIndexError = kt.WasmMimeType)
              : n.includes("networkerror") || n.includes("failed to fetch")
              ? (e.ruffleIndexError = kt.WasmCors)
              : n.includes("disallowed by embedder")
              ? (e.ruffleIndexError = kt.CSPConflict)
              : "CompileError" === e.name
              ? (e.ruffleIndexError = kt.InvalidWasm)
              : n.includes("could not download wasm module") &&
                "TypeError" === e.name
              ? (e.ruffleIndexError = kt.WasmDownload)
              : "TypeError" === e.name
              ? (e.ruffleIndexError = kt.JavascriptConflict)
              : navigator.userAgent.includes("Edg") &&
                n.includes("webassembly is not defined") &&
                (e.ruffleIndexError = kt.WasmDisabledMicrosoftEdge);
          }
      ...
      for (const e in null === (n = this.loadedConfig) || void 0 === n
        ? void 0
        : n.defaultFonts) {
      ...
      if (
        ...
        !this.loadedConfig ||
          this.loadedConfig.autoplay === Gn.On ||
          (this.loadedConfig.autoplay !== Gn.Off &&
            "running" === this.audioState()))
      ) {
        if ((this.play(), "running" !== this.audioState())) {
          (this.loadedConfig &&
            this.loadedConfig.unmuteOverlay === Yn.Hidden) ||
    ...
    checkOptions(e) {
      ...
      const n = (e, n) => {
        if (!e) {
          ...
          throw (
            ((e.ruffleIndexError = kt.JavascriptConfiguration),
            this.panic(e),
            e)
          );
        }
          ...
          try {
            (this.loadedConfig = Object.assign(
              Object.assign(
                Object.assign(
                  Object.assign(
                    Object.assign({}, it),
                    n && "url" in e
                      ? { allowScriptAccess: Et("samedomain", e.url) }
                      : {}
                  ),
                  null !==
                    (a =
              ...
              this.loadedConfig.backgroundColor &&
                this.loadedConfig.wmode !== et.Transparent &&
              ...
              "url" in e
                ? (console.log(`Loading SWF file ${e.url}`),
                  ...
                  this.instance.stream_from(this.swfUrl.href, Rt(e.parameters)))
                : "data" in e &&
            ...
            throw (
              (n.message.includes("Error parsing config") &&
                (n.ruffleIndexError = kt.JavascriptConfiguration),
              this.panic(n),
              n)
            );
          }
    ...
    confirmReloadSave(e, n, t) {
      if (this.isB64SOL(n) && localStorage[e]) {
        if (!t) {
          if (!confirm(ge("save-delete-prompt"))) return;
        }
        ...
        if (a.includes(o) && e.startsWith(r)) {
          return void (
            confirm(
              ge("save-reload-prompt", { action: t ? "replace" : "delete" })
            ) &&
            this.loadedConfig &&
            (this.destroy(),
    ...
    contextMenuItems() {
      ...
      return (
        this.fullscreenEnabled &&
          (this.isFullscreen
            ? n.push({
                text: ge("context-menu-exit-fullscreen"),
                onClick: async () => this.setFullscreen(!1),
              })
            : n.push({
                text: ge("context-menu-enter-fullscreen"),
                onClick: async () => this.setFullscreen(!0),
              })),
        n.push({
          text: ge("context-menu-volume-controls"),
          onClick: async () => {
        ...
        this.instance &&
          ...
          (t(),
          n.push({
            text: ge("context-menu-download-swf"),
            onClick: this.downloadSwf.bind(this),
          })),
        navigator.clipboard &&
          window.isSecureContext &&
          n.push({
            text: ge("context-menu-copy-debug-info"),
            onClick: () => navigator.clipboard.writeText(this.getPanicData()),
          }),
        this.checkSaves() &&
          n.push({
            text: ge("context-menu-open-save-manager"),
            onClick: this.openSaveManager.bind(this),
          }),
        t(),
        n.push({
          text: ge("context-menu-about-ruffle", {
            flavor: pt ? "extension" : "",
            version: ft.versionName,
          }),
          async onClick() {
    ...
    pointerDown(e) {
      (this.pointerDownPosition = new xt(e.pageX, e.pageY)),
        (this.pointerMoveMaxDistance = 0),
    ...
    checkLongPressMovement(e) {
      if (null !== this.pointerDownPosition) {
        const n = new xt(e.pageX, e.pageY),
    ...
    showContextMenu(e) {
      ...
      if (
        (e.preventDefault(),
        0 !== this.shadow.querySelectorAll(".modal:not(.hidden)").length)
      )
        return;
      if (
        ("contextmenu" === e.type
        ...
        [!1, tt.Off].includes(
          ...
          (this.isTouch &&
            (null === (a = this.loadedConfig) || void 0 === a
              ? void 0
              : a.contextMenu) === tt.RightClickOnly) ||
      ...
      const r = this.getBoundingClientRect(),
        o = this.contextMenuElement.getBoundingClientRect(),
        i = Math.max(
          0,
          e.clientX + o.width - document.documentElement.clientWidth
        ),
        s = Math.max(
          0,
          e.clientY + o.height - document.documentElement.clientHeight
        ),
        l = e.clientX - r.x - i,
        u = e.clientY - r.y - s;
      this.contextMenuElement.style.transform = `translate(${l}px, ${u}px)`;
    }
    hideContextMenu() {
      var e;
      null === (e = this.instance) ||
    ...
    getPanicData() {
      ...
      if (
        ...
        (e += "\n# Ruffle Info\n"),
        (e += `Version: ${ft.versionNumber}\n`),
        (e += `Name: ${ft.versionName}\n`),
        (e += `Channel: ${ft.versionChannel}\n`),
        (e += `Built: ${ft.buildDate}\n`),
        (e += `Commit: ${ft.commitHash}\n`),
        (e += `Is extension: ${pt}\n`),
        (e += "\n# Metadata\n"),
        this.metadata)
      )
    ...
    createErrorFooter(e) {
      ...
      for (const t of e) {
        ...
        (a.href = t.url),
          ...
          "#" === t.url ? (a.id = "panic-view-details") : (a.target = "_top"),
          e.appendChild(a),
          n.appendChild(e);
      }
      return n;
    ...
    panic(e) {
      ...
      if (
        ...
        return;
      const t =
          null !== (n = null == e ? void 0 : e.ruffleIndexError) && void 0 !== n
            ? n
            : kt.Unknown,
      ...
      const r = a.join(""),
        o = new Date(ft.buildDate),
        i = new Date();
      i.setMonth(i.getMonth() - 6);
      const s = i > o;
      let l, u, c;
      if (s) l = new zt(bt + "/downloads#desktop-app", ge("update-ruffle"));
      else {
        let e;
        (e =
        ...
        a.stackIndex > -1 &&
          ...
          (t = encodeURIComponent(a.join("")))),
          (n += t),
          (l = new zt(n, ge("report-bug")));
      }
      switch (t) {
        case kt.FileProtocol:
          (u = we("error-file-protocol")),
            (c = this.createErrorFooter([
              new zt(bt + "/demo", ge("ruffle-demo")),
              new zt(bt + "/downloads#desktop-app", ge("ruffle-desktop")),
            ]));
          break;
        case kt.JavascriptConfiguration:
          (u = we("error-javascript-config")),
            (c = this.createErrorFooter([
              new zt(
          ...
          break;
        case kt.WasmNotFound:
          (u = we("error-wasm-not-found")),
            (c = this.createErrorFooter([
              new zt(
          ...
          break;
        case kt.WasmMimeType:
          (u = we("error-wasm-mime-type")),
            (c = this.createErrorFooter([
              new zt(
          ...
          break;
        case kt.InvalidSwf:
          (u = we("error-invalid-swf")),
            (c = this.createErrorFooter([new zt()]));
          break;
        case kt.SwfFetchError:
          (u = we("error-swf-fetch")), (c = this.createErrorFooter([new zt()]));
          break;
        case kt.SwfCors:
          (u = we("error-swf-cors")),
            (c = this.createErrorFooter([
        ...
        case kt.InvalidWasm:
          ...
          break;
        case kt.WasmDownload:
          (u = we("error-wasm-download")),
            (c = this.createErrorFooter([new zt()]));
          break;
        case kt.WasmDisabledMicrosoftEdge:
          (u = we("error-wasm-disabled-on-edge")),
            (c = this.createErrorFooter([
              new zt(
          ...
          break;
        case kt.JavascriptConflict:
          (u = we("error-javascript-conflict")),
            s &&
              u.appendChild(
                we("error-javascript-conflict-outdated", {
                  buildDate: ft.buildDate,
                })
              ),
            (c = this.createErrorFooter([l, new zt()]));
          break;
        case kt.CSPConflict:
          (u = we("error-csp-conflict")),
            (c = this.createErrorFooter([
              new zt(
    ...
    displayRootMovieDownloadFailedMessage(e) {
      ...
      if (o && this.swfUrl && window.location.origin !== this.swfUrl.origin) {
        ...
        (r.className = "message"), r.appendChild(we("message-cant-embed"));
        const i = document.createElement("div"),
          s = document.createElement("a");
        (s.innerText = ge("open-in-new-tab")),
          (s.onclick = () => o(e)),
          i.appendChild(s),
          r.appendChild(i),
          n.appendChild(r),
        ...
        this.swfUrl && !this.swfUrl.protocol.includes("http")
          ? (n.ruffleIndexError = kt.FileProtocol)
          : e
          ? (n.ruffleIndexError = kt.InvalidSwf)
          : window.location.origin ===
              (null === (r = this.swfUrl) || void 0 === r
                ? void 0
                : r.origin) || window.location.protocol.includes("extension")
          ? (n.ruffleIndexError = kt.SwfFetchError)
          : (n.ruffleIndexError = kt.SwfCors),
          this.panic(n);
      }
    }
    displayMessage(e) {
    ...
    displayClipboardModal(e) {
      ...
      n &&
        ((n.textContent = ge("clipboard-message-description", {
    ...
    setMetadata(e) {
      (this._metadata = e),
        (this._readyState = yt.Loaded),
        this.hideSplashScreen(),
        this.dispatchEvent(new CustomEvent(St.LOADED_METADATA)),
        this.dispatchEvent(new CustomEvent(St.LOADED_DATA));
    }
    PercentLoaded() {
      return this._readyState === yt.Loaded ? 100 : 0;
    }
  }
  function jt(e) {
  ...
  function Ct(e, n) {
    ...
    const r = Et(n("allowScriptAccess"), e);
  ...
  (St.LOADED_METADATA = "loadedmetadata"),
    (St.LOADED_DATA = "loadeddata"),
    (function (e) {
  ...
  class It extends St {
    ...
    static isInterdictable(e) {
      ...
      return !!n && !Ft(e) && (qt(n) ? (At(e, "src"), !1) : dt(n, t));
    }
    static fromNativeEmbedElement(e) {
      const n = Kn("ruffle-embed", It),
  ...
  function Pt(e) {
    ...
    for (const r of e.children)
      if (r instanceof HTMLParamElement) {
        const e =
            null === (n = r.attributes.getNamedItem("name")) || void 0 === n
              ? void 0
              : n.value,
          o =
            null === (t = r.attributes.getNamedItem("value")) || void 0 === t
              ? void 0
              : t.value;
        e && o && (a[e] = o);
      }
    ...
    static isInterdictable(e) {
      ...
      const o =
        ...
        i =
          null !==
            (a =
              null === (t = e.attributes.getNamedItem("type")) || void 0 === t
                ? void 0
                : t.value) && void 0 !== a
            ? a
            : null,
      ...
      const u =
        null === (r = e.attributes.getNamedItem("classid")) || void 0 === r
          ? void 0
          : r.value.toLowerCase();
  ...
  const Ut =
    ...
    Nt =
      (function (e) {
        var n;
        let t =
          null !== (n = null == mt ? void 0 : mt.href) && void 0 !== n ? n : "";
        return (
          !pt &&
            "publicPath" in e &&
            null !== e.publicPath &&
  ...
  function Vt() {
    var e, n;
    return (
      (!("favorFlash" in Ut) || !1 !== Ut.favorFlash) &&
      "ruffle.js" !==
        (null !==
          (n =
  ...
  function Zt() {
    try {
      (_t = null != _t ? _t : document.getElementsByTagName("object")),
        (Bt = null != Bt ? Bt : document.getElementsByTagName("embed"));
      for (const e of Array.from(_t))
        if ($t.isInterdictable(e)) {
          const n = $t.fromNativeObjectElement(e);
          e.replaceWith(n);
        }
      for (const e of Array.from(Bt))
        if (It.isInterdictable(e)) {
          const n = It.fromNativeEmbedElement(e);
          e.replaceWith(n);
        }
    } catch (e) {
      console.error(
  ...
  function Kt() {
    (Jt = null != Jt ? Jt : document.getElementsByTagName("iframe")),
      (Ht = null != Ht ? Ht : document.getElementsByTagName("frame")),
      [Jt, Ht].forEach((e) => {
        for (const n of e) {
          ...
          try {
            "complete" === e.document.readyState && Gt(e, t);
          } catch (e) {
            pt || console.warn(t + e);
          }
          n.addEventListener(
  ...
  async function Gt(e, n) {
    ...
    try {
      ...
      return void (pt || console.warn(n + e));
    }
    if (pt || void 0 === a.documentElement.dataset.ruffleOptout)
      if (pt)
        ...
        n.setAttribute("src", Nt),
          (n.onload = () => {
            (e.RufflePlayer = {}), (e.RufflePlayer.config = Ut);
          }),
      ...
      (function (e) {
        ("install" in navigator.plugins && navigator.plugins.install) ||
          Object.defineProperty(navigator, "plugins", {
            value: new Mt(navigator.plugins),
            writable: !1,
          }),
          ...
          !(e.length > 0) ||
            ...
            Object.defineProperty(navigator, "mimeTypes", {
              value: new Ot(navigator.mimeTypes),
              writable: !1,
            });
  ...
  const Xt = {
    version: ft.versionNumber + "+" + ft.buildDate.substring(0, 10),
    polyfill() {
      Yt();
    },
    pluginPolyfill() {
